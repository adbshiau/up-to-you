...
import { Image, Button, Rating, Comment, Icon } from "semantic-ui-react";
  ...
  return (
    <>
      ...
      <Comment.Content>
        ...
        <Button size='tiny' icon onClick={() => deleteReview(review._id)} style={{ marginBottom: '5px', marginTop: '5px' }}><Icon name='erase'/></Button>
      </Comment.Content>
    </>
  );
}